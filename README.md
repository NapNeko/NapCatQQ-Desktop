...
### **【停止更新公告】关于 NapCatQQ-Desktop 项目进入维护状态的说明**

**尊敬的 NapCatQQ-Desktop 用户：**

感谢您长期以来对 NapCatQQ-Desktop 项目的支持与关注。

在此我们郑重宣布，**NapCatQQ-Desktop 项目将于 2025 年 11 月 19 日起停止功能性更新，并正式进入维护状态。**

作出这一决定，主要基于以下两点原因：

1.  **功能覆盖充分**：核心项目 **NapCatQQ 本体** 已经实现了 NapCatQQ-Desktop 约 90% 的功能。继续维护一个功能高度重叠的桌面端版本，其必要性已大幅降低。
2.  **技术架构瓶颈**：桌面项目所依赖的底层组件库日益臃肿，导致应用性能堪忧，难以提供流畅、高效的用户体验。

**这意味着：**
- 此后，本项目将**不再新增任何功能特性**。
- 项目代码库将继续保留，供开发者与用户查阅。
- 项目进入 **“维护状态”**，我们仅会对影响正常使用的**恶性 Bug** 或**严重安全漏洞**进行修复。

**如果您遇到问题：**
如果您在 2025 年 11 月 19 日之后发现了导致程序崩溃、数据丢失或主要功能无法使用的**恶性 Bug**，请通过项目的 **[GitHub Issues](https://github.com/NapNeko/NapCatQQ-Desktop/issues)** 页面进行反馈。我们会评估问题的严重性，并酌情修复。

再次感谢各位的理解与陪伴。开源项目的演进离不开社区的每一份力量，我们期待在 NapCatQQ 的核心项目中继续与您同行。
