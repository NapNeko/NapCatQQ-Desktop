...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::app_framework::astrbot_dashboard_status,
            commands::app_framework::astrbot_list_personas,
            commands::app_framework::astrbot_upsert_persona,
            commands::app_framework::astrbot_delete_persona,
            commands::app_framework::astrbot_list_kbs,
            commands::app_framework::astrbot_create_kb,
            commands::app_framework::astrbot_delete_kb,
            commands::app_framework::astrbot_list_session_rules,
            commands::app_framework::astrbot_update_session_rule,
            commands::app_framework::astrbot_delete_session_rule,
            commands::app_framework::astrbot_list_abconfs,
            commands::app_framework::astrbot_create_abconf,
            commands::app_framework::astrbot_delete_abconf,
            commands::app_framework::astrbot_list_source_models,
            commands::app_framework::astrbot_list_subagent_tools,
