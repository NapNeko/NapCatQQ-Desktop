...
# 用途: 验证开发/生产环境是否配置正确
#
# v2 起 Daemon (Go) 已归档至 archive/daemon-v1/, 仅校验 Python 与项目结构.
...
# Python 语法 (抽样, 整树过 py_compile 太慢)
$pyFiles = Get-ChildItem -Path "src" -Filter "*.py" -Recurse | Select-Object -First 20
$pyErrors = 0
