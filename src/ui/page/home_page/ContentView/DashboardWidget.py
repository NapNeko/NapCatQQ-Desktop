...
# 项目内模块导入
from src.ui.components.InfoCard import BotListCard, CPUDashboard, QQVersionCard, MemoryDashboard, NapCatVersionCard
from src.core.network.urls import Urls
from src.ui.components.message_box import HyperlinkBox
