...
NapCatQQ-Desktop 仅为方便使用 NapCatQQ 的工具，**并非用于违法犯罪的工具**。如用户通过包括但不限于多开等手段，利用本软件从事任何违法犯罪活动，本软件的作者及贡献者不承担任何连带责任。
...
在使用本软件前，请确保您已仔细阅读并完全理解本协议的所有条款。如您不同意本协议中的任何内容，请立即停止使用本软件。
"""
