...
INFO_LOG = PathFunc().log_info_path / f"INFO.{TIME}.log"
DEBUG_LOG = PathFunc().log_debug_path / f"DEBUG.{TIME}.log"
...
class Logger:
    ...
    def __init__(self):
        ...
        # 清理旧日志
        self.cleanup_logs(PathFunc().log_info_path, "INFO.")
        self.cleanup_logs(PathFunc().log_debug_path, "DEBUG.")
