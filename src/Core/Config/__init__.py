...
class Config(QConfig):
    ...
    bgHomePageOpacity = RangeConfigItem(
        group="Personalize", name="BgHomePageOpacity", default=100, validator=RangeValidator(10, 100)
    )
    ...
    bgAddPageOpacity = RangeConfigItem(
        group="Personalize", name="BgAddPageOpacity", default=100, validator=RangeValidator(10, 100)
    )
    ...
    bgListPageOpacity = RangeConfigItem(
        group="Personalize", name="BgListPageOpacity", default=100, validator=RangeValidator(10, 100)
    )
    ...
    bgUnitPageOpacity = RangeConfigItem(
        group="Personalize", name="BgUnitPageOpacity", default=100, validator=RangeValidator(10, 100)
    )
    ...
    bgSettingPageOpacity = RangeConfigItem(
        group="Personalize", name="BgSettingPageOpacity", default=100, validator=RangeValidator(10, 100)
    )
