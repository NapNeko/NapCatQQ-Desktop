...
from src.desktop.core.remote import DeploymentState, ServerManager
...
from src.desktop.ui.page.remote_page.deployment_console import DeploymentConsoleDialog
from src.desktop.ui.page.remote_page.deployment_runner import RollbackRunner
...
class RemoteRollbackCard(SettingCard):
    ...
    [`DeploymentConsoleDialog`](src/desktop/ui/page/remote_page/deployment_console.py)
    实时展示清理日志, 后台用 [`RollbackRunner`](src/desktop/ui/page/remote_page/deployment_runner.py)
    跑 [`ServerManager.rollback_server`](src/desktop/core/remote/server_manager.py)。
