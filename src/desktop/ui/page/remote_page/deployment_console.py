# -*- coding: utf-8 -*-
"""[`DeploymentConsoleDialog`](src/desktop/ui/page/remote_page/deployment_console.py): 部署控制台对话框。

基于 [`MessageBoxBase`](https://qfluentwidgets.com/) 实现, 与项目内其他对话框风格一致;
订阅 [`ServerManager`](src/desktop/core/remote/server_manager.py) 的:
...
- 终端复用项目内组件 [`CodeExibit`](src/desktop/ui/components/code_editor/exhibit.py)
  + [`LogHighlighter`](src/desktop/ui/components/code_editor/highlight.py),
