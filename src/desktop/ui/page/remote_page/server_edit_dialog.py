...
返回新的 [`ServerProfile`](src/desktop/core/remote/servers.py) 与可选密码。
"""
...
class ServerEditDialog(MessageBoxBase):
    ...
    Args:
        ...
        existing_password: 编辑模式下从 [`ServerManager._password_cache`](src/desktop/core/remote/server_manager.py) 注入

    成功 ``exec()`` 后通过 [`get_profile`](src/desktop/ui/page/remote_page/server_edit_dialog.py)
    与 [`get_password`](src/desktop/ui/page/remote_page/server_edit_dialog.py) 取回结果。
    """
    ...
    def get_profile(self) -> ServerProfile:
        """构造并返回新的 [`ServerProfile`](src/desktop/core/remote/servers.py)。
