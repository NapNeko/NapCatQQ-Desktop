...
| 脚本 | 用途 | 构建器 |
| --- | --- | --- |
| `remote_install_linuxqq.sh` | LinuxQQ rootless 安装 | [`build_install_linuxqq_script`](src/desktop/core/remote/templates.py) |
| `remote_install_napcat.sh` | NapCat 注入 + launcher 部署 | [`build_install_napcat_script`](src/desktop/core/remote/templates.py) |
| `remote_napcat_launcher.sh` | 启停/状态查询 (P2 调用) | [`build_napcat_launcher_script`](src/desktop/core/remote/templates.py) |
...
def load_linux_deploy_script() -> str:
    ...
    .. deprecated:: P1
        请改用 [`build_install_linuxqq_script`](src/desktop/core/remote/templates.py)
        与 [`build_install_napcat_script`](src/desktop/core/remote/templates.py)。
    """
...
def build_linux_deploy_script(variables: Mapping[str, str | int]) -> str:
    ...
    .. deprecated:: P1
        见 [`load_linux_deploy_script`](src/desktop/core/remote/templates.py)。
    """
