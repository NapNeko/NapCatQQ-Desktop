...
- [`LocalBackend`](src/desktop/core/operation/local_backend.py) 在 Windows 桌面环境实现这些操作。
- [`RemoteBackend`](src/desktop/core/operation/remote_backend.py) 通过 SSH/SFTP 在 Linux 远端实现。

上层 UI 与 Bot 管理代码通过 [`OperationBackend`](src/desktop/core/operation/backend.py)
